...
dividend_df = pro.dividend(
    ts_code="600519.SH", fields=["ts_code", "end_date", "pay_date", "update_flag", "base_share", "cash_div"]
)
...
income_df = pro.income(
    **{
    ...
    fields=["ts_code", "ann_date", "report_type", "end_type", "total_revenue", "update_flag", "compr_inc_attr_p"],
)
