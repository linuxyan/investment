...
def fetch_hk_exchange_rate():
    ...
    try:
        ...
        print("Error fetching HKD to CNY exchange rate:", e)
    return 0.85
...
def process_positions():
    ...
    with open("data/position.csv", newline='', encoding="utf-8") as csvfile:
    ...
    investment_cost = 0.0
    try:
        with open("data/transfer.csv", newline='', encoding="utf-8") as csvfile:
        ...
        print("Error reading transfer.csv:", e)
    ...
    with open("json/current_position.json", "w", encoding="utf-8") as jsonfile:
    ...
    try:
        with open("json/market_trend.json", "r", encoding="utf-8") as trend_file:
    ...
    try:
        ...
        print("Error reading transfer.csv to recalc:", e)
    ...
    # 排序后写入文件
    trend_data.sort(key=lambda record: datetime.strptime(record.get("date"), "%Y-%m-%d"))
    with open("json/market_trend.json", "w", encoding="utf-8") as trend_file:
